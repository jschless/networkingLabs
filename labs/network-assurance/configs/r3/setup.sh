#!/bin/bash
# r3 — OSPF router with SNMP, syslog, and NetFlow enabled
set -e
...
softflowd -i eth1 -n 172.16.0.10:2055 -v 5 -P udp

echo "[r3] OSPF, SNMPd, syslog→172.16.0.10:514, NetFlow→172.16.0.10:2055 active"
