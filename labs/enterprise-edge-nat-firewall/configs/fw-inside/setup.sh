...
#   eth4  GUEST      10.0.0.9/30     (facing guest-laptop 10.0.0.10)
#
...
ip link set eth4 up
ip addr add 10.0.0.9/30   dev eth4 2>/dev/null || true    # GUEST
...
table inet fw_inside {
    ...
    chain forward {
        ...
        # Guest → internet only
        iif "eth4" oif "eth1" ip saddr 10.0.0.10 accept
...
echo "  GUEST:     10.0.0.9/30    (eth4)  → guest-laptop 10.0.0.10"
echo ""
