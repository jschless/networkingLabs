...
```mermaid
flowchart LR
    r1["r1<br/>2001:db8::1/128<br/>rid 10.0.0.1"]
    r2["r2<br/>2001:db8::2/128<br/>rid 10.0.0.2"]
    r3["r3<br/>2001:db8::3/128<br/>rid 10.0.0.3"]
    r4["r4<br/>2001:db8::4/128<br/>rid 10.0.0.4"]

    r1 -- "2001:db8:12::/64<br/>Area 0" --- r2
    r2 -- "2001:db8:23::/64<br/>Area 0" --- r3
    r3 -- "2001:db8:34::/64<br/>Area 0" --- r4
