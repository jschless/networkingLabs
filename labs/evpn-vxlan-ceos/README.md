...
```bash
# Leaves and spines
docker exec -it clab-evpn-vxlan-ceos-leaf1 Cli
docker exec -it clab-evpn-vxlan-ceos-spine1 Cli

# Hosts (to run pings)
docker exec -it clab-evpn-vxlan-ceos-host-a1 Cli
docker exec -it clab-evpn-vxlan-ceos-host-b1 Cli
```
...
docker exec -it clab-evpn-vxlan-ceos-host-a1 Cli -c "ping 10.10.10.12 repeat 5"
...
docker exec -it clab-evpn-vxlan-ceos-host-a1 Cli -c "ping 10.10.10.12 repeat 5"
docker exec -it clab-evpn-vxlan-ceos-host-b1 Cli -c "ping 10.20.20.12 repeat 5"

! ✗ FAIL — cross-tenant (must be blocked)
docker exec -it clab-evpn-vxlan-ceos-host-a1 Cli -c "ping 10.20.20.11 repeat 5"
docker exec -it clab-evpn-vxlan-ceos-host-b1 Cli -c "ping 10.10.10.11 repeat 5"
