...
| `ops-lab:local` | `aaa-ops-troubleshooting`, `anycast-dns`, `dhcp-dns-troubleshooting`, `ipv6-access-services`, `management-access-control`, `ztp-basics` | `docker build -t ops-lab:local images/ops-lab/` |
