...
- :material-chart-line: **Network Operations** (17 labs)
    ...
    ---
    Management access, DHCP/DNS, AAA, hybrid-flow evidence, packet capture, MTU troubleshooting, correlated SNMP/syslog/SPAN/sensor-NetFlow evidence, QoS, zero-touch provisioning, API automation, NetBox, SuzieQ observability, GitOps change safety, and gNMI telemetry
